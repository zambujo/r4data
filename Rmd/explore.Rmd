...
denorm <- people %>% 
  ...
  mutate(
    ...
    content = glue(
      ...
      "<hr/><a href='{project_slug}' target='_blank' rel='noopener noreferrer'>{project_title}</a><br/><br/>",
      ...
      "Start <span class='label label-default'>{start_date}</span>&emsp;&ensp;",
      "End <span class='label label-default'>{end_date}</span>&emsp;&ensp;",
