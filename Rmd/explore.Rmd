...
# Read -----
r4d <- read_rds(here("data", "r4d-grants-in-p3.Rds")) # p3 project data on r4d
affil <- read_rds(here("data", "r4d-affiliations.Rds")) #  p3 people data on r4d
...
details <- r4d %>%
  mutate(
    ...
    col_label = ifelse(running, "#5c636e", "#5c636e")) %>%
  select(project_number, p3, project_title, keywords, start_date, end_date, col_label)
