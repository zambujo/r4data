...
gmaps <- gmaps %>%
  mutate(gmaps_addr_ascii = stringi::stri_trans_general(gmaps_addr, "Latin-ASCII")) %>%
  extract(gmaps_addr_ascii, "gmaps_country", regex = "(?<=[,] )(\\w+$)")
write_csv(gmaps, here("data", "gmaps.csv"))
```


Add "difficult" cases separately.
